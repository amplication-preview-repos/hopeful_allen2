...
@InputType()
class RegistrationCreateNestedManyWithoutCoursesInput {
...
export { RegistrationCreateNestedManyWithoutCoursesInput as RegistrationCreateNestedManyWithoutCoursesInput };
